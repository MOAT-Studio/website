 ...
 * ink marks at each shoulder. The rail across the foot names the
 * operating model and links into the process chapter.
 *
 ...
 *
 * Every decorative layer (orb, brush marks) is pure SVG and
