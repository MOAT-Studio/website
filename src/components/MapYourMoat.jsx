...
export default function MapYourMoat({ onClose }) {
  ...
  // Escape returns to the site; heading takes focus on every step so keyboard
  // and screen-reader position follows the flow.
  useEffect(() => {
    const onKey = (e) => {
  ...
  return (
    <div className="moat-assess" role="dialog" aria-modal="true" aria-label="Map your Moat assessment">
      <div className="moat-assess-inner">
        ...
        {!atResult && (
          <div className="moat-question" key={question.id}>
            ...
            <div className="moat-options" role="radiogroup" aria-label={question.prompt}>
